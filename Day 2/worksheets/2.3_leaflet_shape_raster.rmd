...
The default open street map tiles are added to a leaflet widget using ``addTiles()`` while third party tiles can be added using ``addProviderTiles()``
...
# some other third party tile examples
