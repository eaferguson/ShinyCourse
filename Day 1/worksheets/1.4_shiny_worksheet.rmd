...
Please take a moment to have a look at the server and ui scripts, then run the app.
<br><br>
<h4 class="blue">Goal: Add another text output to the side panel</h4>
<br>
<em>
Hints:
<ul>
...
Please take a moment to have a look at the server and ui scripts, then run the app.
<br><br>
<h4 class="blue">Goal: Change the dropdown from Species to Region  </h4>
<br>
<em>
Hints:
<ul>
...
Please take a moment to have a look at the server and ui scripts, then run the app.
<br><br>
<h4 class="blue">Goal: Change the checkboxes from Sex to Species  </h4>
<br>
<em>
Hints:
<ul>
...
Please take a moment to have a look at the server and ui scripts, then run the app.
<br><br>
<h4 class="blue">Goal: Change from a 1-sided to a 2-sided slider  </h4>
<br>
<em>
Hints:
<ul>
...
<br><br>
This is the same timeseries app as before, but with a new ``actionButton()`` below the others.
<br><br>
Please take a moment to have a look at the server and ui scripts, then run the app.
<br><br>
