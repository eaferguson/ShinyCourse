...
<ul>
<li>ggplot2 has individual functions for each type of plot, and additional plotting features such as lines and error bars.</li>
<li>This allows the user to layer multiple types of plot e.g. bars and lines.</li>
...
<div class = "col-md-6">
<h4>geom_line</h4>
Lineplot, connects observations in the order they appear on the x-axis
```{r echo = TRUE, message = FALSE, warning = FALSE, fig.height = 3}
ggplot() + 
...
<div class = "col-md-6">
<h4>geom_path</h4>
Lineplot, connects observation in the order they appear in the data
```{r echo = TRUE, message = FALSE, warning = FALSE, fig.height = 3}
ggplot() + 
  geom_path(data=summary_data, 
            aes(x=month, y=mean_age, color=sex),
            size=1) + 
  theme_classic()
```
...
``` {r, echo=FALSE}
plot_types <- data.frame("1"=rep("Additional features", 3),
                      "function name"=c("``geom_abline()``, ``geom_hline()``, ``geom_vline()``", 
                                        "``geom_errorbar()``",
                                        "``geom_text()``, ``geom_label()``"),
                      "description"=c("reference lines (diagonal, horizontal, vertical)", 
                                      "error bars",
                                      "text mapped to plot location (no background, white background)"))

kable_styling(kable(plot_types, col.names=c("", "function name", "description")), 
