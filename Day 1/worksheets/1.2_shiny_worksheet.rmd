...
<li><a href="#1.4b">1.4b Add an option to a radio button widget</a></li>
...
<b class="blue">Goal: Create an app in a single R script</b>
<ol>
...
<b class="blue">Goal: Create an app using multiple R scripts</b>
<ol>
<li> On the top menu, click on:  </li>
&nbsp;&nbsp; File > New File > Shiny Web App  
...
<br><br>
<b class="blue">Goal: Add age as an option  to view on the x-axis</b>
<ul>
...
Please take a moment to have a look at the server and ui scripts, then run the app.
<br><br>
<b class="blue">Goal: Add another text output </b>
<ul>
