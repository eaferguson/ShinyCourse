...
The 2 methods are very similar, but it can be easier to seperate your code and sections using the 'multiple file' layout.  
...
<!----------------------------------------------------------------------------->
## Using inputs and outputs together: <em>code</em>  
...
<!----------------------------------------------------------------------------->
## Using inputs and outputs together: <em>example</em>
...
<!----------------------------------------------------------------------------->
## The ``reactive()`` function: <em>code</em> {.smaller}
...
<!----------------------------------------------------------------------------->
## The ``reactive()`` function: <em>app</em>
...
<!----------------------------------------------------------------------------->
##  ``reactiveValues()`` & ``observeEvent()`` functions: <em>code</em>
...
<!----------------------------------------------------------------------------->
## ``reactiveValues()`` & ``observeEvent()`` functions: <em>app</em>
